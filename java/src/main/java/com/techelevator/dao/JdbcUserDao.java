...
public class JdbcUserDao implements UserDao {
    ...
    public User getUserByUsername(String username) {
        ...
        User user = null;
        String sql = "SELECT user_id, username, password_hash, role FROM users WHERE LOWER (username) = LOWER (?);";
        try {
    ...
    public User addAdminRole(String userName) {
        ...
        try {
            ...
            int rowsAffected = jdbcTemplate.update(sql, adminRole, userName);
            if (rowsAffected > 0) {
